...
<form action="{{ route('matieres.store') }}" method="POST">
    ...
    <div class="container bg-light shadow-lg p-3 m-3  rounded">
        <div class="row gx-5">
            ...
            <div class="col-md-6 ">
                <input type="text" name="nom" class="form-control" placeholder="Nom Matiere" >
            </div>
            <div class="col-md-6">
                <input type="text" name="categorie" class="form-control" placeholder="Categorie " aria-label="Last name">
            </div>
           
            <div class="col-md-6 mt-4">
                <input type="text" name="codeIA" class="form-control" placeholder="Code IA" aria-label="codeIA">
            </div>
            <div class="col-md-6 mt-4">
                <input type="text" name="structureCible" class="form-control" placeholder="Structure Cible" aria-label="structureCible">
            </div>
            <!-- <div class="col-md-6 mt-4 ">
